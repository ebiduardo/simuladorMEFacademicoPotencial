...
!
      write(inout,'(a)') "*conectividades_ladais{"
  100 continue                                                          
...
!
      ...
      write(inout,'(a)') "*conectividades_nodais{"
  100 continue                                                          
      read(iin,1000) n,m,(itemp(i),i=1,nen),ng     
      if(n==0) then
         write(inout,'(i10)') zero
...
!
      ...
      integer :: i, j, m, mgen    
!                                                                       
      write(inout,'(a)') "*coordenadas_nodais{"
