...
INTERFACE solverHypre
      MODULE PROCEDURE resolverSistemaAlgHYPRE, resolverSistemaAlgHYPRE01 !, resolverSistemaAlgHYPRE02
END INTERFACE solverHypre 

      public  criarMatriz_HYPRE01
      public   criarVetor_HYPRE01
...
!
!=============================================================================
      subroutine resolverSistemaAlgHYPRE  (A_, parcsr_A_, b_, par_b_, u_, par_u_, solver_, solver_id_, precond_id_, &
...
!     PCG with ParaSails
     ...
     !stop " apos call escreverResultadosHYPRE"
      !write(*,*) " fim de subroutine resolverSistemaAlgHYPRE"
