...
NETCDF:=3
# If value is '3' and CPPDEFS contains
...
#BD CPPDEFS += -DHAVE_SCHED_GETAFFINITY


# Macro for Fortran preprocessor
FPPFLAGS := $(INCLUDES)
# Fortran Compiler flags for the NetCDF library
#BD FPPFLAGS += $(shell nf-config --fflags)
# Fortran Compiler flags for the MPICH MPI library
#BD FPPFLAGS += $(shell pkg-config --cflags-only-I mpich2)

# Base set of Fortran compiler flags
FFLAGS := -fcray-pointer -fdefault-double-8 -fdefault-real-8 -Waliasing -ffree-line-length-none -fno-range-check
FFLAGS := -I /opt/intel/oneapi/mpi/2021.10.0/include -w -module ../include -DwithHYPRE -Dwithcrs -fopenmp -DwithOMP
...
#BD CPPFLAGS += $(shell nc-config --cflags)
# C Compiler flags for the MPICH MPI library
#BD CPPFLAGS += $(shell pkg-config --cflags-only-I mpich2)
...
#BD LIBS += $(shell nf-config --flibs)
# MPICH MPI library flags
#BD LIBS += $(shell pkg-config --libs mpich2-f90)
...
ifeq ($(HYPRE),1) #BD
    HYPRE_LIB=/mnt/c/Users/bidu/OneDrive/aLncc/lib/hypre-2.11.2/appWindows/lib
    HYPRE_LIB=/opt/hypre-2.11.2/src/lib/appWindows
    HYPRE_LIB=/mnt/c/Users/bidu/OneDrive/aLncc/lib/hypre-2.11.2_intel/src/lib
    CPPDEFS += -Dbidu3
    LDFLAGS := -L$(HYPRE_LIB) -lHYPRE -fopenmp
endif
