...
!
      ...
      use mGlobaisEscalares, only: pTempo
...
!
      ...
      real*8 :: plTempoAnt(1,nen), pTA_int
...
!
      ...
      end subroutine nucleoEstacionario

      subroutine  nucleoTransiente
...
!
      ...
      end subroutine  nucleoTransiente
